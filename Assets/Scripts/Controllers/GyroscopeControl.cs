...
public class GyroscopeControl : MonoBehaviour
{
	...
	#region [Unity events]
		...
		protected void OnGUI ()
		{
				if (debug) {
						...
						GUILayout.Label ("transformObject.rotation: " + transformObject.localRotation);
						...
						if (GUILayout.Button ("Reset camera rotation", GUILayout.Height (80))) {
								transformObject.localRotation = Quaternion.identity;
						}
				}
		}
	...
	#region [Public methods]
		...
		/// <summary>
		/// Attaches gyro controller to the transformObject.
		/// </summary>
		...
		/// <summary>
		/// Detaches gyro controller from the transformObject
		/// </summary>
